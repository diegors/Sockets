...
public class SSLServer2 {
	...
	public static void main(String[] args) throws Exception{
		...
		int intSSLport = 2005; // Port where the SSL Server needs to listen for new requests from the client

		{
			...
			System.setProperty("javax.net.ssl.keyStore","D:/DevelopmentWork/Repositories/GIT/Others/Demos/Sockets/SSLSocketServer/src/ssl/socket/server/diegoKEYSTORE.ks");
			System.setProperty("javax.net.ssl.keyStorePassword","diego1981");
